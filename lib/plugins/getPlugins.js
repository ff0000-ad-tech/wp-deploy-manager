...
module.exports = function getPlugins({ DM, PM, buildEntry, fbaTypes, base64Inline, debug }) {
	const plugins = [
		...
		new CopyWebpackPlugin(
			...
			{
				ignore: ['+(index*|payload*|bundle*|VERSION*)', '*(backup*+(jpg|png|gif))', 'images/**/*', 'js/**/*', 'platform/**/*']
			}
		),
